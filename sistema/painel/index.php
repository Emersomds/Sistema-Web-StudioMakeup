...
<body class="cbp-spmenu-push">
	<div class="main-content">
			...
			<aside class="sidebar-left">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="#"><span ><img src="images/salon.png" alt="" class="iconsiste"></span> Sistema<span class="dashboard_text"><?php echo $nome_sistema ?></span></a></h1>
					</div>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<li><a href="index.php?pag=clientes"><i class="fa fa-angle-right"></i> Clientes</a></li>
								</ul>
							</li>
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									<li><a href="index.php?pag=servicos"><i class="fa fa-angle-right"></i>Serviços</a></li>

									<li><a href="index.php?pag=cargos"><i class="fa fa-angle-right"></i> Cargos</a></li>

									<li><a href="index.php?pag=cat_servicos"><i class="fa fa-angle-right"></i> Categoria Serviços</a></li>
		...
		<!--footer-->
		<div class="footer">
			<p><i> Desenvolvedor Emerson Matos <a href="https://api.whatsapp.com/message/5Q75WB3IDLWQG1?autoload=1&app_absent=0" target="_blank"><i class="fa fa-whatsapp" style="font-size:24px; color: green"></i></i></a></p>		
		</div>
		<!--//footer-->
	</div>
